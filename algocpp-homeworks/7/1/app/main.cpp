/**
 * @brief Задача 1. Обход в глубину
 * @note  https://github.com/netology-code/algocpp-homeworks/tree/main/7/01
 */
#include <iostream>
#include <string>
#include <windows.h>
...
void dfs(int**& graph, int vertex, int*& visited, int sizeGraph) {
  std::cout << " " << vertex+1;
