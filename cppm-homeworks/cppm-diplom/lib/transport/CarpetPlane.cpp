...
#define NAME_CARPET_PLANE_RU "Ковёр-самолёт"
#define NAME_CARPET_PLANE_EN "Carpet-plane"
...
CarpetPlane::CarpetPlane() : AirTransport(NAME_CARPET_PLANE_EN, SPEED_CARPET_PLANE)
{
