/**
 * @brief Задача 2 на практику к главе 1.3
 * @note  напишите программу, которая создает строку 
 * на русском языке в кодировке UTF-8, и выводит её 
 * на экран и в файл. Убедитесь что текст в файле читаемый.
 */
